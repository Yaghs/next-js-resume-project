    ...
    return(
        <main>
           <div className="flex flex-col lg:flex-row items-start gap-4 lg:gap-8 pt-12 lg:pt-24 max-w-6xl mx-auto px-4 lg:px-6">
                ...
                <div>
                    <h1 className="text-3xl pt-20">Programming languages</h1>
                    <div className="flex justify-center gap-10 pt-10">
                        <div className="relative inline-block group">
                            <Image  src="/JavaScript.png" alt="Java-script-logo" width={200} height={200}/>
                            <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:bg-black hover:opacity-90 transition duration-300">
                        ...
                        <div className="relative inline-block group">
                            <Image  src="/TypeScript.png" alt="Type-script-logo" width={200} height={200}/>
                            <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:bg-black hover:opacity-90 transition duration-300">
                ...
                <div>
                    <h1 className="text-3xl pt-20">Frameworks/Libraries</h1>
                     <div className="flex justify-center gap-10 pt-10">
                        <div className="relative inline-block group">
                ...
                <div>
                    <h1 className="text-3xl pt-20">Technologies</h1>
                     <div className="flex justify-center gap-10 pt-10">
                        <div className="relative inline-block group">
                ...
                <div>
                    <h1 className="text-3xl pt-20">Tools</h1>
                     <div className="flex justify-center gap-10 pt-10">
                        <div className="relative inline-block group">
